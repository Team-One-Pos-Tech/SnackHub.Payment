...
using Refit;
using SnackHub.Payment.Infra.Gateways.MercadoPago.Models;
using SnackHub.Payment.Infra.Gateways.MercadoPago.Models.POS;
using SnackHub.Payment.Infra.Gateways.MercadoPago.Models.Store;

namespace SnackHub.Payment.Infra.Gateways.MercadoPago.Abstractions;
